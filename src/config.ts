...
const config = {
  ...
  title: "Grow It Rapid",
  description:
    "Welcome to GrowItRapid.com, your premier destination for cutting-edge 360-degree marketing solutions. Our website is dedicated to helping businesses thrive in the ever-changing digital landscape through our innovative approach and unparalleled expertise.",
  author: "Bishal Nandi",
  locale: "en_US",
  type: "website",
  emails: ["bishal.nandi@growitrapid.com", "growitrapid@gmail.com"],
